...
//Filenames
#define DUMP_FILENAME  "0:AppF1_dump.bin"
#define FLASH_FILENAME "0:AppF1.upd"
#define LOG_FILENAME   "0:AppF1_log.txt"
...
//It must be on a flash page boundary after the size of our actual bootloader
//If our bootloader takes ~ 22KB then the app can be at 32KB which is page 16
#define APPLICATION_ADDRESS        (uint32_t)0x08008000

//The flash pages to check for write protection
//STM32F105 has up to 32x 2k pages
//Bit set to 1 means write protection not active on this sector
//We can check all pages with OB_WRP_ALLPAGES or only the ones occupied by the application
#define FLASH_PAGE_TO_CHECK_WRP (uint32_t)0xFFFFFF00
...
#define DATA_SIZE() (file.fsize - 4)
#else
#define DATA_SIZE() (file.fsize)
#endif
